...
$smarty->assign('site_title','Welcome to installation');
...
$check = false;
$smarty->assign('msg','<div class="alert alert-danger text-center" >We didnt find mysqli extension enabled . Please ask your hosting company to enable it.</div>');
}
