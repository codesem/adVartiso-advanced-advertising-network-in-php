{include file='../Layout/header.tpl'}
                                ...
                                <div class="card-box">
                                    <div class="text-center">
                                        <div class="alert alert-success">
                                            ...
                                            <span class="text-uppercase">{$_EMAIL}:</span> <b>{do_config(25)}</b>
                                        </div>
                                    </div><hr>
                     ...
                     {if $do_error}<div class="alert alert-{$_SOME_WRONG}">{$__SOME_WRONG}</div>{/if}                                    
                        					<form class="form-horizontal" method="POST">
                                                ...
                                                <button type="submit" class="btn btn-black waves-effect w-md m-b-5"><i class="fa fa-envelope"></i> {$_CONTACT}</button>
	                                        </form>
