                        ...
                        <ul class="nav navbar-nav navbar-left">
                            <li>
                              ...
                              <li class="dropdown hidden-xs">
                                <a href="{$PUB}settings/index" class="dropdown-toggle menu-item" href="#" aria-expanded="false"><div class="fa fa-cog"></div> {$_SETTINGS}</a>
                              </li>
                              <li class="dropdown hidden-xs">
                                <a href="{$PUB}support" class="dropdown-toggle menu-item" href="#" aria-expanded="false"><div class="fa fa-envelope"></div> {$_SUPPORT}</a>
                              </li>
                            <li class="dropdown hidden-xs">
                        ...
                        <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li>
                                        <a href="#" class="user-list-item">
                                            <div class="icon bg-danger">
                                               ...
                                               {elseif $foo['type'] == 'withdrawal'}
                                                <i class="fa fa-dollar"></i>
                                               {elseif $foo['type'] == 'website'}
                                            ...
                                            <div class="user-desc">
                                               ...
                                               {elseif $foo['type'] == 'referral'}
                                                <span class="white-color">{$_NEW_REFERRAL_REGISTRED}</span>
                                               {elseif $foo['type'] == 'withdrawal'}
                                                <span class="white-color">{$_AMOUNT} {do_amount($foo['amount'])} {$_WAS_SENT}</span>
                                               {elseif $foo['type'] == 'website'}
                                                <span class="white-color">{$foo['title']}</span>
                                               {/if}
                                            </div>
                                        </a>
                                    </li>
                            ...
                            <li class="dropdown user-box">
                                ...
                                {if $role == 'admin'}
                                    ...
                                    <li><a href="{$ADV}dashboard"><i class="fa fa-user"></i> {$_ADVERTISER_AREA}</a></li>
                                {/if}
                                    <li><a href="{$PUB}settings/index"><i class="fa fa-cog"></i> {$_SETTINGS}</a></li>
            ...
            <div class="left side-menu">
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div id="sidebar-menu">
                        <ul>
                        	<li class="menu-title">
                        	    <h5 class="white-color text-uppercase"><i class="fa fa-money"></i> {$_BALANCE}: {do_amount($pub_balance)}</h5>
                        	 </li>
                            <li>
                                <a href="{$PUB}dashboard" class="waves-effect"><i class="fa fa-dashboard"></i><span> {$_DASHBOARD}</span></a>
                            </li>
                            <li>
                                <a href="{$PUB}stats/index" class="waves-effect"><i class="fa fa-bar-chart"></i><span> {$_STATS}</span></a>
                            </li>
                            <li>
                                <a href="{$PUB}websites/index" class="waves-effect"><i class="fa fa-bars"></i><span> {$_WEBSITES}</span></a>
                            </li>
                            <li>
                                <a href="{$PUB}zones/index" class="waves-effect"><i class="fa fa-code"></i><span> {$_ZONES}</span></a>
                            </li>
                            <li>
                                <a href="{$PUB}withdraws/index" class="waves-effect"><i class="fa fa-dollar"></i><span> {$_WITHDRAWAL}</span></a>
                            </li>
                        	<li class="menu-title text-uppercase">{$_USER_AREA} </li>
                            <li>
                                <a href="{$PUB}announcements/index" class="waves-effect"><i class="fa fa-bullhorn"></i><span> {$_ANNOUNCEMENTS} </span></a>
                            </li>
                            <li>
                                <a href="{$PUB}referrals" class="waves-effect"><i class="fa fa-users"></i><span> {$_REFERRALS}</span></a>
                            </li>
                            <li>
                                <a href="{$PUB}support" class="waves-effect"><i class="fa fa-envelope"></i><span> {$_SUPPORT}</span></a>
                            </li>
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        ...
                                        <li>
                                            <a href="{$PUB}dashboard">{$_PUBLISHER}</a>
                                        </li>
                                        <li class="active">
                                            {$site_title}
                                        </li>
