                               ...
                               <div class="card-box">
                                   ...
                                   <form class="form-horizontal" method="POST">
                                       ...
                                       <div class="form-group">
                                           ...
                                           <div class="col-md-6">
                                               <select id="select_role" name="option" class="form-control">
                                                   <option value="smtp" {if do_config(30)=='smtp'}selected="selected"{/if}>SMTP</option>
                                                   <option value="php_mail" {if do_config(30)=='php_mail'}selected="selected"{/if}>PHP Mail</option>
                                               </select>
                                          </div>
                                       </div>
                                       <script>
                                       ...
                                       <div class="form-group">
                                           ...
                                           <div class="col-md-6">
                                               <input type="text" name="support_email" class="form-control" value="{do_config(13)}"/>
                                           </div>
                                       </div>
                                       <div id="hidden_div" {if do_config(30) == 'smtp'} style="display: yes;" {else} style="display: none;" {/if}>
                                            <div class="form-group">
                                               <label for="Username" class="col-md-10"> Username</label>
                                               <div class="col-sm-6">
                                                   <input type="text" name="username" class="form-control" value="{do_config(31)}"/>
                                               </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Port" class="col-md-10"> Port </label>
                                                <div class="col-sm-6">
                                                    <input type="text" name="port" class="form-control" value="{do_config(33)}"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="Host" class="col-md-10"> Host </label>
                                                <div class="col-md-6">
                                                    <input type="text" name="host" class="form-control" value="{do_config(32)}"/>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <select name="ssl" class="form-control">
                                                        <option value="ssl" {if do_config(34) == 'ssl'} selected="selected" {/if}>SSL</option>
                                                        <option value="tls" {if do_config(34) == 'tls'} selected="selected" {/if} >TLS</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <input type="password" name="pass" class="form-control" value="{do_config(35)}"/>
                                                </div>
                                            </div>
                                        </div>
