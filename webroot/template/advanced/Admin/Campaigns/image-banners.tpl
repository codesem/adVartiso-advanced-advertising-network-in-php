{include file='../Layout/header.tpl'}
     ...
     {include file='../Campaigns/menu.tpl'}
                                   {foreach from=$imgbanners item=foo}
                                     ...
                                     <div id="modal-img-{$foo['id']}" class="modal fade" tabindex="-1" role="dialog" style="display: none;" aria-hidden="true">
                                         <div class="modal-dialog" style="width:70%; max-width: none;">
                                             <div class="modal-content">
                                                 <div class="modal-header">
                                                     <h4 class="modal-title mt-0">Image #{$foo['id']}</h4>
                                                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                         <span aria-hidden="true">×</span>
                                                     </button>
                                                </div>
                                   ...
                                   {/foreach}
                                     <div class="table-responsive">
                                               ...
                                               {/if}</td>
                                                                <td>
                                                                    <a href="" class="btn btn-black btn-xs" data-toggle="modal" data-target="#modal-img-{$foo['id']}">
