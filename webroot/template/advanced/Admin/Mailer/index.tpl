<div class=""><div class="aHl"></div><div id=":no" tabindex="-1"></div><div id=":nd" class="ii gt"><div id=":nc" class="a3s aXjCH " role="gridcell" tabindex="-1"><div class="adM">
 ...
 {elseif $m_role == 'activate'}
  ...
  <p>Once you do, you're account will be active.</p>
 ...
 {elseif $m_role == 'recover'}
  ...
  <p>If you are the one who do this action please click the link below to reset your password :</p>
  <a href="{$HOST}auth/forgot-password/{$m_token}/" style="border-radius:6px;background:#528c00;border-collapse:separate!important;border:0;color:#ffffff;font-family:'Helvetica Neue',Helvetica,Arial;font-size:15px;font-weight:500;text-align:center;text-decoration:none" target="_blank">
      Confirm
  </a><br>
  <small>Once you confirm your email, Password be reset.</small>
