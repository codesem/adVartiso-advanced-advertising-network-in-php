                                ...
                                <div class="card-box">
	                                            ...
	                                            <div class="form-group">
	                                                <div class="col-md-10">
	                                                    ...
	                                                    <em>Get Your Purchase Code By Purchasing The 
	                                                       <a href="https://codsem.com/item/6689/advartiso-advanced-advertising-network-php/" target="_blank">(Premium Version)</a>
	                                                    </em>
	                                                </div>
	                                            </div>
                                    ...
                                    {if !$prmcode} style="display:none;" {/if}>
                                        <div class="text-center">
                                            ...
                                            <p>Now you can enjoy all amazing features that {$APP} provide</p>
                                            <hr>
                                            <img src="{$UPD}images/script.svg" alt="{$APP}" width="750" height="350">
                                        </div>
	                                </div>
                                </div> <!-- end card -->
