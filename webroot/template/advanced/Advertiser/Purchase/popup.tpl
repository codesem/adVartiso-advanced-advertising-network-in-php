{include file='../Layout/header.tpl'}
                     ...
                     {if $do_error}<div class="alert alert-{$_SOME_WRONG}">{$__SOME_WRONG}</div>{/if}  
                                   ...
                                   <div class="text-center">
                                       <span class="badge badge-danger">{$_POPUPS_HAVE_ONLY_CPC_TYPE}</span>
                                   </div><hr>

                        					<form class="form-horizontal" method="POST">
                                                
                                                <input type="hidden" name="order-popup" value="order-popup"/>
	                                            ...
	                                            <div class="form-group">
	                                                <div class="col-md-10">
	                                                    <input type="number" name="clicks" class="form-control" placeholder="Order Clicks" min="{do_config(37)}" step="10" value="{do_config(37)}"  id="order" onkeyup="priceData('popup','clicks')" onBlur="priceData('popup','clicks')" required>
	                                                    <span class="badge badge-danger">{$_CPC}: {do_amount(do_config(47))}</span>
	                                                </div>
	                                            </div>
	                                            <div class="form-group">
	                                                <div class="col-md-10">
