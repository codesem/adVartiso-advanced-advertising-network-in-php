{include file='../Layout/header.tpl'}
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="col-md-6" style="margin-left: 225px;">
                                                                <select onChange="GrabePreview(this.value,'img_banner');" class="form-control">
                                            ...
                                            {/foreach}
                                                        ...
                                                        <div class="text-center">
                                                            <span id="preview-data">
                                                                <iframe src="{$ZN}preview/img_banner/728x90/" scrolling="no" width="100%" height="100%" style="{do_size('728x90','iframe')}border:0px;padding:0px;overflow:hidden;" allowtransparency="true"></iframe>
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                     ...
                                     <div class="text-center">
                                         <a href="" class="badge badge-danger" data-toggle="modal" data-target="#modal-prev"><i class="fa fa-image"></i> {$_BANNER_AD_PREVIEW} </a>
                        					...
                        					<form id="upload_form" class="form-horizontal" method="post" enctype="multipart/form-data">
                                                ...
                                                <input type="hidden" name="order-imgbanner" value="order-imgbanner"/>
                                                <input type="hidden" name="csrf" value="{$csrfToken}"/>
	                                            <div class="form-group">
	                                                <div class="col-md-10">
	                                                    <select name="method" onChange="CampMethod(this.value,'img_banner');" class="form-control" required>
                    ...
                    {/foreach}
	                                            ...
	                                            <div class="form-group">
	                                                <div class="col-md-10">
	                                                    <span id="method-data">
	                                                        <input type="number" name="views" class="form-control" placeholder="{$_ORDER}" min="{do_config(37)}" step="10" value="{do_config(37)}"  id="order" onkeyup="priceData('img_banner','views')" onBlur="priceData('img_banner','views')" required>
	                                                        <span class="badge badge-danger">{$_CPM}: {do_amount(do_config(48))}</span>
	                                                    </span>
	                                                </div>
	                                            </div>
	                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-md-12">
                                                        <div id="upload-files" class="upload-file">
                                                            ...
                                                            <input id="file-input" type="file" name="banner-file" onchange="uploadBanner()"/>
                                                        </div>
                                                ...
                                                <button type="submit" class="btn btn-black waves-effect w-md m-b-5 submitBtn" disabled="disabled"><i class="fa fa-shopping-cart"></i> {$_CREATE_CAMPAIGN}</button>
	                                        </form>
