<?php /* Smarty version Smarty-3.1.21-dev, created on 2021-03-30 11:07:41
         compiled from "/home/codsemco/projects.codsem.com/proads/webroot/template/Advanced/Admin/Options/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:147207377060607062c80069-86584270%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2238f40d98551df980cf41733a4ce2b37d70f0d6' => 
    array (
      0 => '/home/codsemco/projects.codsem.com/proads/webroot/template/Advanced/Admin/Options/index.tpl',
      1 => 1617102426,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147207377060607062c80069-86584270',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_60607062cb09d9_93724565',
  'variables' => 
  array (
    'generale' => 0,
    'design' => 0,
...
<?php if ($_valid && !is_callable('content_60607062cb09d9_93724565')) {function content_60607062cb09d9_93724565($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("../Layout/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
...
" min="1" required=""/>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-md-10">
                                                 <input name="sizes" class="form-control" type="text" data-role="tagsinput" value="<?php echo do_config(20);?>
"/>
                                                 <em class="font-600 forhelp">Press (ENTER) after typing each size.</em>
                                             </div>
                                         </div>
                                         <div class="form-group">
...
" min="5" max="60"/>
                                                 <em class="font-600 forhelp">Enter number in percent.</em>
                                             </div>
                                         </div>
                                         <div class="form-group">
                                             <label for="views_min" class="col-md-6">Munimum Views</label>
                                             <div class="col-md-10">
                                                 <input name="views_min" class="form-control" type="number" value="<?php echo do_config(36);?>
" min="1"/>
                                                 <em class="font-600 forhelp">Munimum Views must advertiser order.</em>
                                             </div>
                                         </div>
                                         <div class="form-group">
                                             <label for="admin_percent" class="col-md-6">Munimum Clicks</label>
                                             <div class="col-md-10">
                                                 <input name="clicks_min" class="form-control" type="number" value="<?php echo do_config(37);?>
" min="1"/>
                                                 <em class="font-600 forhelp">Munimum clicks must advertiser order.</em>
                                             </div>
                                         </div>
                                         <button type="submit" class="btn btn-black btn-bordered waves-effect w-md m-b-5"> <?php echo $_smarty_tpl->tpl_vars['_SAVE']->value;?>
</button>
...
"/>
                                         ...
                                         <hr><h5>Campaigns Prices</h5><br>
                                         
                                         <div class="form-group">
                                             <label for="cpm_popup" class="col-md-6">CPM popup</label>
                                             <div class="col-md-10">
                                                 <input name="cpm_popup" class="form-control" type="text" value="<?php echo do_config(47);?>
"/>
                                                 <em class="font-600 forhelp">Cost per 1000 views.</em>
                                             </div>
                                         </div>
                                         <div class="form-group">
                                             <label for="cpm_direct" class="col-md-6">CPM direct links</label>
                                             <div class="col-md-10">
                                                 <input name="cpm_direct" class="form-control" type="text" value="<?php echo do_config(44);?>
"/>
                                                 <em class="font-600 forhelp">Cost per 1000 visits.</em>
                                             </div>
                                         </div>
                                         <div class="form-group">
                                             <label for="cpm_img_banner" class="col-md-6">CPM Image banner</label>
                                             <div class="col-md-10">
                                                 <input name="cpm_img_banner" class="form-control" type="text" value="<?php echo do_config(48);?>
"/>
                                                 <em class="font-600 forhelp">Cost per 1000 views.</em>
                                             </div>
                                         </div>
                                         <div class="form-group">
                                             <label for="cpc_img_banner" class="col-md-6">CPC Image banner</label>
                                             <div class="col-md-10">
                                                 <input name="cpc_img_banner" class="form-control" type="text" value="<?php echo do_config(49);?>
"/>
                                                 <em class="font-600 forhelp">Cost per click.</em>
                                             </div>
                                         </div>
                                         <div class="form-group">
                                             <label for="cpm_img_banner" class="col-md-6">CPM TEXT banner</label>
                                             <div class="col-md-10">
                                                 <input name="cpm_text_banner" class="form-control" type="text" value="<?php echo do_config(45);?>
"/>
                                                 <em class="font-600 forhelp">Cost per 1000 views.</em>
                                             </div>
                                         </div>
                                         <div class="form-group">
                                             <label for="cpc_text_banner" class="col-md-6">CPC TEXT banner</label>
                                             <div class="col-md-10">
                                                 <input name="cpc_text_banner" class="form-control" type="text" value="<?php echo do_config(46);?>
"/>
                                                 <em class="font-600 forhelp">Cost per click.</em>
                                             </div>
                                         </div>
