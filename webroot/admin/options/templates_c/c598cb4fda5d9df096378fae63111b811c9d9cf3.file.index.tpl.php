<?php /* Smarty version Smarty-3.1.21-dev, created on 2021-06-24 01:13:19
         compiled from "/storage/ssd2/175/17088175/public_html/webroot/template/advanced/Admin/Options/index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:96148356660cdd7f08ee204-94449827%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c598cb4fda5d9df096378fae63111b811c9d9cf3' => 
    array (
      0 => '/storage/ssd2/175/17088175/public_html/webroot/template/advanced/Admin/Options/index.tpl',
      1 => 1624497196,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '96148356660cdd7f08ee204-94449827',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.21-dev',
  'unifunc' => 'content_60cdd7f0988e00_39147236',
  'variables' => 
  array (
    'generale' => 0,
    'design' => 0,
...
<?php if ($_valid && !is_callable('content_60cdd7f0988e00_39147236')) {function content_60cdd7f0988e00_39147236($_smarty_tpl) {?><?php echo $_smarty_tpl->getSubTemplate ("../Layout/header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, null, array(), 0);?>
                                         ...
                                         <div class="form-group">
                                             ...
                                             <div class="col-md-10">
                                                 <select name="language" class="form-control">
                                                     <option value="en_US" 
                                                     <?php if (do_config(12)=='en_US') {?> selected="selected" <?php }?>>
                                                         English (United States)
                                                     </option>
                                                     <option value="fr_FR" 
                                                     <?php if (do_config(12)=='fr_FR') {?>selected="selected"<?php }?>>
                                                         French (France)
                                                     </option>
                                                    <!-- 
                                                     <option value="es_ES" 
                                                     <?php if (do_config(12)=='es_ES') {?> selected="selected" <?php }?>>
                                                         Spanish (Spain)
                                                     </option>
                                                     <option value="ar_SA" 
                                                     <?php if (do_config(12)=='ar_SA') {?>selected="selected"<?php }?>>
                                                         Arabic (Saudi Arabia)
                                                     </option>
                                                     <option value="ru_RU" 
                                                     <?php if (do_config(12)=='ru_RU') {?> selected="selected" <?php }?>>
                                                         Russian (Russia)
                                                     </option>
                                                     <option value="hi_IN" 
                                                     <?php if (do_config(12)=='hi_IN') {?>selected="selected"<?php }?>>
                                                         Hindi (India)
                                                     </option>
                                                    -->
                                                 </select>
